...
public class ExprParser extends Parser {
	...
	public static final int
		...
		WS=11;
	public static final int
		RULE_prag = 0, RULE_stat = 1, RULE_expr = 2;
	...
	public static class PragContext extends ParserRuleContext {
		...
		public PragContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_prag; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).enterPrag(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).exitPrag(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitPrag(this);
			else return visitor.visitChildren(this);
		}
	}

	public final PragContext prag() throws RecognitionException {
		PragContext _localctx = new PragContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_prag);
		int _la;
		try {
