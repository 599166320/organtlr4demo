 ...
 */
grammar Java;
@header{package org.java.antlr4;}
@lexer::members {
...
//添加('public')*
methodDeclaration
    :   ('public')* type Identifier formalParameters ('[' ']')* methodDeclarationRest
    |   ('public')* 'void' Identifier formalParameters methodDeclarationRest
    ;
